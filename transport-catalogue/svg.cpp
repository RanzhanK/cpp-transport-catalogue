...
namespace transport_catalogue::svg {
    ...
    Rgb::Rgb(uint8_t red, uint8_t green, uint8_t blue) : red_(red), green_(green), blue_(blue) {}

    Rgba::Rgba(uint8_t red, uint8_t green, uint8_t blue, double opacity) : red_(red), green_(green), blue_(blue),
                                                                           opacity_(opacity) {}
