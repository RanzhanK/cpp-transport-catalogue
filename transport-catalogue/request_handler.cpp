...
namespace request_handler {
    ...
    Node RequestHandler::ExecuteMakeNodeStop(int id_request, StopQueryResult stop_info) {
        Dict result;
        Array buses;
    ...
    Node RequestHandler::ExecuteMakeNodeBus(int id_request, BusQueryResult bus_info) {
        Dict result;
        std::string str_not_found = "not found";
    ...
    Node
    RequestHandler::ExecuteMakeNodeMap(int id_request, TransportCatalogue &catalogue_, RenderSettings render_settings) {
        Dict result;
    ...
    void RequestHandler::ExecuteQueries(TransportCatalogue &catalogue, std::vector<StatRequest> &stat_requests,
